...
?>
		<div id="contenuto">
			...
			<p>Verso gli anni 90, soprattutto in Giappone e in Asia, si sviluppò un nuovo sottogenere, definito "<strong xml:lang="en">Bullet Hell</strong>" o "<strong xml:lang="en">Danmaku</strong>" (<ruby><rb><span xml:lang="ja">弾幕</span></rb><rp>(</rp><rt><span xml:lang="ja">だんま</span>く</rt><rp></ruby>, "sbarramento"), che si basano su un elevato numero di proiettili a schermo di dimensione solitamente ridotta da evitare con precisione millimetrica.<br/>
			...
			<h3>Protagoniste</h3>
			<p>Al posto delle classiche navicelle spaziali od aerei si andranno a controllare delle ragazze, le principali sono <em xml:lang="en">Marisa Kirisame</em> e <em xml:lang="en">Reimu Hakurei</em>, sacerdotesse di un tempio shintoista.<br/>
			...
			<p>Vengono definite <span xml:lang="en">spellcard</span> i <em><span xml:lang="en">pattern</span> d'attacco</em> dei boss dei vari livelli, che a differenza di altri giochi vengono indicati al giocatore, in modo che possa prepararsi adeguatamente.<br/>
			...
			Sono molto utili per liberarsi da situazioni senza via d'uscita, in quanto se non si presta attenzione ai <span xml:lang="en">pattern</span> d'attacco dei nemici ci si può ritrovare circondati dai proiettili.</p></dd>
