...
<head>
		...
		<meta name="title" content="Gameplay - Touhou Italia"/>
	...
	<title>Gameplay - Touhou Italia</title>
</head>
<body>
	<div id="subheader">
	<div id="header">
		...
		<div id="menudiv">
			<ul id="menu">
				...
				<li class="disable"><span xml:lang="en">Gameplay</span></li>
	...
	<div id="contenitore">
		<div id="contenuto">
			...
			<p>
			<img class="odd" src="images/Ikaruga.jpg" alt="Ikaruga, gioco Bullet Hell giapponese"/>Verso gli anni 90, soprattutto in Giappone e in Asia, si sviluppò un nuovo sottogenere, definito "<strong xml:lang="en">Bullet Hell</strong>" o "<strong xml:lang="en">Danmaku</strong>" (<ruby><rb><span xml:lang="ja">弾幕</span></rb><rp>(</rp><rt><span xml:lang="ja">だんまく</span></rt><rp>)</rp></ruby>, "sbarramento"), che si basano su un elevato numero di proiettili a schermo di dimensione solitamente ridotta da evitare con precisione millimetrica.<br/>
			...
			<h3>Protagoniste</h3>
			<p><img src="images/protagoniste.jpg" alt="Alcuni personaggi di Touhou"/>Al posto delle classiche navicelle spaziali od aerei si andranno a controllare delle ragazze, le principali sono <em xml:lang="en">Marisa Kirisame</em> e <em xml:lang="en">Reimu Hakurei</em>, sacerdotesse di un tempio shintoista.<br/>
			...
			<img src="images/gensokyo.jpg" alt="Panoramica con un tempio di Gensokyo"/>
