...
<head>
		...
		<meta name="title" content="Sviluppo - Touhou Italia"/>
	...
	<title>Sviluppo - Touhou Italia</title>
</head>
<body>
	<div id="subheader">
		<div id="header">
	...
	<div id="contenitore">
		<div id="contenuto">
			...
			<dl>
				...
				<dd>
				<img src="images/pc98.jpg" class="even" alt="Immagine del PC-98, ormai ingiallito"/>
	...
	I giochi successivi apportarono molti miglioramenti grafici al gioco, mantenendo una qualità in linea con il sesto capitolo.
				...
				<dd>
				<img src="images/MountainofFaith.jpg" class="even" alt="Alcuni personaggi aggiunti di recente alla serie"/>
