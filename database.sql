...
('11', 2008, '東方地霊殿　～ Subterranean Animism', '11.jpg', '', 'Subterranean Animism', 'Animismo sotterraneo', 'Dopo aver superato lo tsuchigumo Yamame Kurodani, l\'eroina raggiunge l\'ex capitale, un luogo dove ora vivono gli oni. Yuugi Hoshiguma sfida l\'eroina in una battaglia amichevole, per poi che l\'eroina dovrebbe andare al Palazzo degli Spiriti della Terra. Qui, l\'eroina incontrò Satori Komeiji, il proprietario di Rin Kaenbyou (Orin) e Utsuho Reiuji (Okuu). Rin desidera che l\'eroina scendesse e la aiutasse a fermare la sua amica prima che riuscisse a divenire troppo forte.', 11),
...
(2, 'A caccia di demoni', 0, '2017-12-12 20:03:40', 'NIS America ha deciso di portate in occidente un altro titolo estremamente di nicchia, appartenente al genere dei <span xml:lang=\"en\">dungeon crawler</span> che negli ultimi anni ha vissuto una sorta di seconda vita grazie ai tanti nuovi esponenti. <span xml:lang=\"en\">Touhou Genso Wanderer</span> va a incasellarsi nel più ampio <span xml:lang=\"en\">Touhou Project</span>, un insieme di titoli nati come sparatutto a scorrimento che nel corso degli anni ha trovato nuovi esponenti ispirati alla serie ma di genere differente. <span xml:lang=\"en\">Touhou Genso Wanderer</span> mantiene comunque intatti alcuni elementi legati ai titoli della serie principale, come ad esempio il setting della storia ambientata sempre nella regione di Gensokyo, un luogo fantastico dove umani e demoni convivono da secoli.', 'touhougensowanderer.jpg', 'Immagine di una schermata del gioco'),
(3, 'Pubblicato capitolo 13', 0, '2018-01-17 22:52:55', 'Inserito capitolo 13! Una nuova avventura comincia per le nostre eroine! ', 'capitolo13.jpg', 'Immagine capitolo 13 Touhou');
